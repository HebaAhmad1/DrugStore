...
namespace DrugStore.Data.Migrations
{
    ...
    [Migration("20220719140018_AddSpecialLocationAndCompanyTab")]
    partial class AddSpecialLocationAndCompanyTab
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrugStoreData.Models.NewConact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DrugStoreData.Models.SpecialCompany", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("CID")
                        .IsUnique()
                        .HasFilter("[CID] IS NOT NULL");

                    b.ToTable("SpecialCompanies");
                });

            modelBuilder.Entity("DrugStoreData.Models.SpecialLocations", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<int?>("SpecialCompanyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SpecialCompanyId");

                    b.ToTable("SpecialLocations");
                });
            ...
            modelBuilder.Entity("DrugStoreData.Models.SpecialLocations", b =>
                {
                    b.HasOne("DrugStoreData.Models.SpecialCompany", "SpecialCompany")
                        .WithMany("SpecialLocations")
                        .HasForeignKey("SpecialCompanyId");

                    b.Navigation("SpecialCompany");
                });
