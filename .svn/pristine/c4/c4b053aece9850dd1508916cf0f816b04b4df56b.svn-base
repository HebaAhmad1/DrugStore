...
namespace DrugStore.Data.Migrations
{
    ...
    [Migration("20220127131448_UpdateTabDrugPharmacyOrderDetailPharmacyOrder")]
    partial class UpdateTabDrugPharmacyOrderDetailPharmacyOrder
    {
            ...
            modelBuilder.Entity("DrugStoreData.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("DrugStoreData.Models.PharmacyOrders", "PharmacyOrder")
                        .WithMany("Orders")
